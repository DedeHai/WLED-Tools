Fonts source: downloaded from https://github.com/IT-Studio-Rech/bdf-fonts

the readme on the original source is not up to date regardig the tom-thumb.bdf font: 
the original is here https://robey.lag.net/2010/01/23/tiny-monospace-font.html
according to that page tom-thumb was also released into public domain in 2015.

According to the download source, all fonts are public domain:
